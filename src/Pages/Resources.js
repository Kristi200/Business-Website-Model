...
const Resources = () => {
  ...
  const setStatus = (button) => {
    console.log(button.target.name)
    if(button.target.name === "all"){
      setAllPost(!allPost)
      setFeatured(false)
    }else{
  ...
  return (
    <div>
      ...
      <div className="h-72 bg-gray-950 text-center flex justify-center flex-col text-white">
        <p className="text-6xl">Resources</p>
        <p className="mt-5 text-2xl">Expand your knowledge tookit by reading</p>
        <p className="mt-3 text-2xl">from the most prominent experts</p>
      </div>
      <div className="flex flex-row font-medium ml-16 mt-10">
        <button type="button" name="all"  onClick={(name) => setStatus(name)} className={(allPost) ? "mr-10 hover:text-violet-400 cursor-pointer text-violet-500" : "mr-10 hover:text-violet-400 cursor-pointer"}>All Posts</button>
        <button type="button" name="featured" onClick={(name) => setStatus(name)} className={(featured) ? "mr-10 hover:text-violet-400 cursor-pointer text-violet-500" : "mr-10 hover:text-violet-400 cursor-pointer"}>Featured Post</button>
      </div>
      {(featured)         
        ...
        {/* Post 4 */}
        <div className="border ml-5  mt-5 mb-5" style={{ width: "600px" }}>
            <img src={require("../Images/image10.jpg")} alt="img-1" style={{ height: "300px", width: "600px" }} />
            <p className="text-xs mt-5 ml-5">Jan 12 • 1 min</p>
            <p className="text-2xl my-5 ml-5">New data tools you should know</p>
            <p className="ml-5">Create a blog post subtitle that summarizes your post in a few short, punchy</p>
            <p className="ml-5 mb-12"> senteces and entices your audience to continue reading...</p>
            <div className="border-b mb-3 mx-5">
            </div>
            <div className="flex flex-row justify-center mb-3">
                ...
                <div className="flex flex-row">
                    <span className="text-xs ml-72 mr-2">1</span>
                    <svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" viewBox="0 0 25 25" fill='red'><title>Likes</title>
                        <path d="M12 4.595a5.904 5.904 0 0 0-3.996-1.558 5.942 5.942 0 0 0-4.213 1.758c-2.353 2.363-2.352 6.059.002 8.412l7.332 7.332c.17.299.498.492.875.492a.99.99 0 0 0 .792-.409l7.415-7.415c2.354-2.354 2.354-6.049-.002-8.416a5.938 5.938 0 0 0-4.209-1.754A5.906 5.906 0 0 0 12 4.595zm6.791 1.61c1.563 1.571 1.564 4.025.002 5.588L12 18.586l-6.793-6.793c-1.562-1.563-1.561-4.017-.002-5.584.76-.756 1.754-1.172 2.799-1.172s2.035.416 2.789 1.17l.5.5a.999.999 0 0 0 1.414 0l.5-.5c1.512-1.509 4.074-1.505 5.584-.002z"></path>
                    </svg>
                </div>
        ...
        {/* Post 5 */}
        <div className="border ml-16  mt-5 mb-5" style={{ width: "600px" }}>
            <img src={require("../Images/image11.jpg")} alt="img-1" style={{ height: "300px", width: "600px" }} />
            <p className="text-xs mt-5 ml-5">Jan 12 • 1 min</p>
            <p className="text-2xl my-5 ml-5">10 ways to reach new clients</p>
            <p className="ml-5">Create a blog post subtitle that summarizes your post in a few short, punchy</p>
            <p className="ml-5 mb-12"> senteces and entices your audience to continue reading...</p>
            <div className="border-b mb-3 mx-5">
            </div>
            <div className="flex flex-row justify-center mb-3">
                ...
                <div className="flex flex-row">
                    <span className="text-xs ml-72 mr-2">0</span>
                    <svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" viewBox="0 0 25 25" fill='red'><title>Likes</title>
                        <path d="M12 4.595a5.904 5.904 0 0 0-3.996-1.558 5.942 5.942 0 0 0-4.213 1.758c-2.353 2.363-2.352 6.059.002 8.412l7.332 7.332c.17.299.498.492.875.492a.99.99 0 0 0 .792-.409l7.415-7.415c2.354-2.354 2.354-6.049-.002-8.416a5.938 5.938 0 0 0-4.209-1.754A5.906 5.906 0 0 0 12 4.595zm6.791 1.61c1.563 1.571 1.564 4.025.002 5.588L12 18.586l-6.793-6.793c-1.562-1.563-1.561-4.017-.002-5.584.76-.756 1.754-1.172 2.799-1.172s2.035.416 2.789 1.17l.5.5a.999.999 0 0 0 1.414 0l.5-.5c1.512-1.509 4.074-1.505 5.584-.002z"></path>
                    </svg>
                </div>
        ...
        {/* Post 6 */}
        <div className="border ml-5  mt-5 mb-5" style={{ width: "600px" }}>
            <img src={require("../Images/image12.jpg")} alt="img-1" style={{ height: "300px", width: "600px" }} />
            <p className="text-xs mt-5 ml-5">Jan 12 • 1 min</p>
            <p className="text-2xl my-5 ml-5">A business trend or a fad</p>
            <p className="ml-5">Create a blog post subtitle that summarizes your post in a few short, punchy</p>
            <p className="ml-5 mb-12"> senteces and entices your audience to continue reading...</p>
            <div className="border-b mb-3 mx-5">
            </div>
